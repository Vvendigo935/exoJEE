...
@WebServlet(name = "servlet2B", value = "/servlet2B")
public class ServletExo2B extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        getServletContext().getRequestDispatcher("/jsp2B.jsp").forward(req, resp);
